...
본 프로젝트는 **Team HandL**이 DAKER HACKATHON 참가를 위해 개발하였습니다.

수상 이후 체결된 권리 양도 계약에 따라, 본 프로젝트의 저작권 및 관련 지식재산권은 **DACON**에 귀속됩니다.

본 저장소는 대회 평가 및 개발 이력 확인을 위한 목적으로 공개되어 있으며, 소스코드의 무단 복제, 수정, 재배포 및 상업적 이용을 금합니다.
