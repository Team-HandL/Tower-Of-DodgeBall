...
// ─── 대칭 배치 기준 ─────────────────────────────────────────────
//   좌우 대칭축: x = 450  (컬럼 9.375)
//     col 4  ↔  col 14   (각각 x=192, x=672 — 중앙에서 ±258/222px)
//     col 8~10 = 중앙 벽  (x=384~528, 중심 x=456 ≈ 450)
//   상하 대칭축: y = 300  (로우 6.25)
//     row 2-3 (y=96~192)  ↔  row 9-10 (y=432~528)
//     row 4   (y=192~240) ↔  row 8    (y=384~432)

export const OBSTACLE_GROUPS = [
  // 좌측 상단 기둥  (플레이어 코트 상단)
  [{c:4, r:2}, {c:4, r:3}],

  // 우측 상단 기둥  (NPC 코트 상단 — col 4 좌우 대칭)
  [{c:14, r:2}, {c:14, r:3}],

  // 중앙 상단 벽  (col 8-10 → 중심 x≈456, 상단)
  [{c:8, r:4}, {c:9, r:4}, {c:10, r:4}],

  // 좌측 하단 기둥  (상단 기둥의 상하 대칭)
  [{c:4, r:9}, {c:4, r:10}],

  // 우측 하단 기둥  (상단 기둥의 상하 대칭)
  [{c:14, r:9}, {c:14, r:10}],

  // 중앙 하단 벽  (중앙 상단 벽의 상하 대칭)
